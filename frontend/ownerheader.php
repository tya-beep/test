...
$stmt = $connPG->prepare("SELECT owner_id, owner_name, phone_num, email, address, username FROM owner WHERE owner_id = :owner_id");
...
<body class="index-page">
    ...
    <ul>
        ...
        <li><a href="upcomingappointments.php">Upcoming Appointment</a></li>
...
<li class="dropdown"><a href="#"><span>Payment</span> <i
                        ...
                        <ul>
                            ...
                            <li><a href="php">Payment History</a></li>
                        </ul>
                    </li>
